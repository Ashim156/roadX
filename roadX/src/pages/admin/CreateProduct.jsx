...
const CreateProduct = () => {
  ...
  return (
   ...
   <h2 className='text-gray-800 text-[2rem] font-bold text-center'>CREATE PRODUCT</h2>
   ...
   <div>
    ...
    <div className="w-full text-center text-xl bg-gray-800 shadow-lg shadow-gray-500/50 hover:shadow-gray-500/40 text-white font-semibold rounded-lg">
      <button  onClick={handelProduct}>Create Product</button>
    </div>
